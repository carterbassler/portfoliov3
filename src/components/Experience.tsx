...
function Experience({ experience }: Props) {
  return (
    <div className="flex flex-row space-x-4 group hover:bg-[#0a1930] hover:bg-opacity-50 transition duration-500 ease-in-out rounded-lg p-3">
      <div className="flex w-1/4">
        <h1 className="text-white text-md text-opacity-80">
          {experience.duration}
        </h1>
      </div>
      <div className="flex w-3/4 justify-center">
        <div className="flex flex-col space-y-2">
          <div>
            ...
            <h1 className="text-white text-lg text-opacity-80">
              {experience.position}
            </h1>
            <h1 className="text-white text-md text-opacity-80">
